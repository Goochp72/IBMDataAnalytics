...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        average_sales = recession_data.groupby(df(['Vehicle_Type'])['Automobile_Sales'].mean().reset_index())                 
        R_chart2  = dcc.Graph(
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        exp_rec= recession_data.groupby(df(['Vehicle_Type'])['Advertising_Expenditure'].sum().reset_index())
        R_chart3 = dcc.Graph(
            figure=px.pie(exp.rec,
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    # Check for Yearly Statistics.                             
    elif statistics == 'Yearly Statistics' and selected_year:
        yearly_data = data[data['Year'] == selected_year]

        # Plot 1
        yas = data.groupby('Year')['Automobile_Sales'].mean().reset_index()
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', title='Yearly Avg Auto Sales'))
        ...
        return html.Div("Please select a valid statistic option or year.")
